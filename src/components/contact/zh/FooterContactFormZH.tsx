...
export const FooterContactFormZH = () => {
  ...
  const options = [
    { id: 'A', label: '仅限网站建设（基础版套餐）' },
    { id: 'B', label: '全套品牌 + 网站建设（专业版套餐）' },
    { id: 'C', label: '还不确定 —— 聊聊看吧！' }
  ];
    ...
    try {
      const response = await fetch("https://api.web3forms.com/submit", {
        ...
        body: JSON.stringify({
          ...
          ...formData,
          subject: "来自 Bonbon Design 中文网站的新咨询",
          from_name: "Bonbon Design 中文网站",
        }),
      });
  ...
  if (status === 'success') {
    return (
      ...
      >
        ...
        <h3 className="text-3xl font-serif mb-4 text-white">消息已发送！</h3>
        <p className="text-white/80 text-lg mb-8">我们将在 24 小时内回复您。</p>
        ...
        <div className="lg:col-span-5 text-left py-4">
          <div className="mb-16">
            <div className="mb-6 inline-flex items-center gap-2 bg-[#1a1a1a] text-white px-4 py-2 rounded-full text-sm font-medium backdrop-blur-sm border border-white/10 shadow-lg">
              ...
              <span>抓紧时间，仅剩 3 个名额。</span>
            </div>
            <h2 className="text-5xl md:text-6xl lg:text-7xl tracking-tight mb-4 text-white leading-tight">
              <span className="font-sans font-medium">您准备</span> <br className="hidden md:block" />
              <span className="font-serif italic font-normal">好了吗？</span>
            </h2>
          ...
          <div className="space-y-10">
            <div className="space-y-1">
              <h4 className="text-xs font-bold text-white uppercase tracking-wider opacity-50">电子邮箱</h4>
            ...
            <div className="space-y-1">
              <h4 className="text-xs font-bold text-white uppercase tracking-wider opacity-50">地址</h4>
          ...
          <form onSubmit={handleSubmit} className="space-y-5 bg-white/5 backdrop-blur-md p-6 md:p-8 rounded-[2rem] shadow-2xl border border-white/10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
              <div className="space-y-1.5">
                <label htmlFor="name" className="text-sm font-bold text-white flex items-center gap-1">
                  您的姓名 <span className="text-purple-400">*</span>
                </label>
                <input
                  type="text"
                  id="name"
              ...
              <div className="space-y-1.5">
                <label htmlFor="email" className="text-sm font-bold text-white flex items-center gap-1">
                  电子邮箱 <span className="text-purple-400">*</span>
                </label>
                <input
                  type="email"
                  id="email"
            ...
            <div className="space-y-1.5">
              <label htmlFor="businessName" className="text-sm font-bold text-white flex items-center gap-1">
                您的公司名称是？ <span className="text-purple-400">*</span>
              </label>
            ...
            <div className="space-y-2">
              <label className="text-sm font-bold text-white flex items-center gap-1 justify-between cursor-pointer" onClick={() => setIsDropdownOpen(!isDropdownOpen)}>
                <div className="flex items-center gap-1">
                  您在寻找什么服务？ <span className="text-purple-400">*</span>
                </div>
            ...
            <div className="space-y-1.5">
              <label htmlFor="message" className="text-sm font-bold text-white flex items-center gap-1">
                聊聊您的公司吧！ <span className="text-white/40 font-normal text-xs">(选填)</span>
              </label>
              <textarea
                id="message"
                name="message"
                ...
                placeholder="例如：我是一家位于布里斯班的花店老板，想建立一个新网站来接收在线咨询并展示我的作品。"
              />
            </div>
            ...
            >
              {status === 'submitting' ? '正在跳转...' : '预约 15 分钟咨询'}
            </Button>
